...
CRISIS_KEYWORDS = [
    ...
    r'סכנת חיים', r'אובדני', r'מחשבות אובדניות',
    r'גמרתי', r'נגמר לי', r'אין לי כוח יותר לחיות',
    r'קפיצה', r'לקפוץ', r'כדורים', r'לבלוע כדורים',
]
...
def is_crisis_message(text):
    """בדיקה אם ההודעה מכילה סימני משבר"""
...
async def handle_navigator_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # --- זיהוי משבר: תגובה קשיחה לפני AI ---
